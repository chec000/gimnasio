                      ...
                      <div class="row">
                           ...
                           <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="flag" class="img_src form-control" name="flag" value='{{$membresia->imagen}}'  type="text">
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <input id="duracion" value="{{$membresia->duracion}}" type="date" class="form-control{{ $errors->has('duracion') ? ' is-invalid' : '' }}" name="duracion" value="{{ old('duracion') }}" required>
