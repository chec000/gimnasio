...
class Order extends Eloquent
{
    ...
    protected $table = 'shop_orders';
        ...
        {
            return $this->belongsTo('Modules\Shopping\Entities\Bank','bank_id');
        }
    ...
    public function getOrderInfo($order_id)
    {
        $data = $this->query()
            ->join('shop_orderestatus', 'shop_orders.order_estatus_id', '=', 'shop_orderestatus.id')
            ->join('shop_shipping_address', 'shop_orders.id', '=', 'shop_shipping_address.order_id')
            ->select(
                ...
                'shop_shipping_address AS ssa_id',
