...
class Legal extends Eloquent
{
    ...
    protected $fillable = ['country_id', 'active_contract', 'active_disclaimer', 'active_policies', 'active', 'delete',
        'last_modifier_id', 'purpose_id'];

    public $translatedAttributes = ['contract_pdf', 'disclaimer_html', 'contract_html', 'policies_pdf'];
