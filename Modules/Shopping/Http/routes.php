...
foreach (TranslatableUrlPrefix::getTranslatablePrefixesByIndex('shopping') as $lang => $prefix) {
    ...
    Route::group(['middleware' => ['web', 'cms.brand_middleware', 'prefix_translate', 'auth.eo', 'exit.eo'], 'prefix' => $prefix,
...
foreach (TranslatableUrlPrefix::getTranslatablePrefixesByIndex('register') as $lang => $prefix) {
    ...
    Route::group(['middleware' => ['web', 'cms.brand_middleware'], 'prefix' => 'register', 'namespace' => 'Modules\Shopping\Http\Controllers'],
        function () {
...
foreach (TranslatableUrlPrefix::getTranslatablePrefixesByIndex('client-register') as $lang => $prefix) {
    ...
    Route::group(['middleware' => ['web', 'cms.brand_middleware'], 'prefix' => 'client-register', 'namespace' => 'Modules\Shopping\Http\Controllers'], function () {
