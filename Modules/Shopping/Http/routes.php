...
Route::group(['middleware' => ['web', 'cms.brand_middleware', 'auth.eo', 'exit.eo'], 'prefix' => 'shopping', 'namespace' => 'Modules\Shopping\Http\Controllers'], function()
{
    ...
    Route::post('/checkout/confirmation/', 'CheckoutController@confirmation')->name('checkout.confirmation');
...
Route::group(['middleware' => ['web','cms.brand_middleware'], 'prefix' => 'register', 'namespace' => 'Modules\Shopping\Http\Controllers'], function()
{
    ...
    //Route::post('/warehouse', ['as' => 'register.warehouse', 'uses' => 'RegisterController@getWarehouseFromCorbiz']);
    Route::post('/transactionFromCorbiz', ['as'=>'register.transactionFromCorbiz','uses'=>'RegisterController@transactionFromCorbiz']);

    Route::post('/confirmation', ['as'=>'register.confirmation','uses'=>'RegisterController@confirmation']);
...
Route::group(['middleware' => ['web','cms.brand_middleware'], 'prefix' => 'registercustomer', 'namespace' => 'Modules\Shopping\Http\Controllers'], function()
{
    Route::get('/', ['as' => 'registercustomer', 'uses' => 'RegisterCustomerController@index']);
    Route::post('/update_session', ['as' => 'registercustomer.update_session', 'uses' => 'RegisterCustomerController@postUpdateSession']);
    ...
    Route::get('/activation', ['as' => 'registercustomer.activation', 'uses' => 'RegisterCustomerController@getActivation']);
