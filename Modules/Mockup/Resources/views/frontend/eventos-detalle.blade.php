                    ...
                    <header class="ezone__header">
                        <div class="ezone__headline">
                            <ul class="ezone__breadcrumbs list-nostyle">
                                <li>@lang('distributorarea::front_lang.events.events')</li>
                                <li>@lang('distributorarea::front_lang.events.event_detail')</li>
                            </ul>
                            <h1 class="ezone__title">@lang('distributorarea::front_lang.events.event_name')</h1>
                            <h4 class="ezone__subtitle">DD / MM / AA</h4>
                        </div>
                    </header>
                    <div class="ezone__jumbotron">
                        <video poster="{{ asset('themes/omnilife2018/images/video-poster.jpg') }}">
                            <source src="{{ asset('themes/omnilife2018/images/video-arena-audio.webm') }}" type="video/webm">
                            <source src="{{ asset('themes/omnilife2018/images/video-arena-audio.mp4') }}" type="video/mp4">
                            <source src="{{ asset('themes/omnilife2018/images/video-arena-audio.ogv') }}" type="video/ogg">
                        </video>
                        ...
                        <div class="ezone__textcontent">
                            ...
                            <aside class="ezone__banners mul">
                                ...
                                <figure class="ezone__banner large"><img src="{{ asset('themes/omnilife2018/images/banner-download.jpg') }}" alt="">
                                    <figcaption><a class="button" href="#">@lang('distributorarea::front_lang.events.add_event_calendar')</a></figcaption>
                                </figure>
                            </aside>
                        </div>
                    </div>
