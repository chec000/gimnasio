        ...
        <header class="products-page__h">
            <div class="wrapper">
                <ul class="products-page__tabs list-nostyle">
                    ...
                    <li class="products-page__tab">Sistemas</a></li>
                </ul>
            </div>
        </header>
            ...
            <div class="products-block grid has-dropdown">
                <div class="products-desc wrapper">
                    ...
                    <div class="products-filter">
                        <h2 class="products-filter__title">Filtrados por:</h2>
                        <ul class="products-filter__list list-nostyle">
                            <li class="products-filter__item active"><a href="#">Los más vendidos</a></li>
                            <li class="products-filter__item"><a href="#">Nuevos</a></li>
                            <li class="products-filter__item"><a href="#">Comprados recientemente</a></li>
                        </ul>
                        <div class="products-filter__dropdown dropdown light">
                            <span class="dropdown-toggle products-filter__dropdown">
                                Los más vendidos
                                <div class="dropdown-list">
                                    <ul class="list-nostyle">
                                        <li class="dropdown-item highlight">Los más vendidos</li>
                                        <li class="dropdown-item">Nuevos</li>
                                        <li class="dropdown-item">Comprados recientemente</li>
                                    </ul>
                                </div>
                            </span>
                        </div>
                ...
                <div class="products">
                    ...
                    <div class="pager">
                        <a class="pager__ctrl prev" href="#">
                            ...
                            <span class="pager__label">Página anterior</span>
                        </a>
                        ...
                        <a class="pager__ctrl next" href="#">
                            <span class="pager__label">Página siguiente</span>
                            <span class="pager__arrow"></span>
                        </a>
                    </div>
                </div>
