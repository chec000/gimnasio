...
@section('content')
    <div class="ezone"><!-- zone container -->
        <div class="wrapper full-size-mobile ezone__container">
            ...
            <!-- content zone -->
            <div class="ezone__content ezone__details travel"><!-- history section -->
                <section class="ezone__section">
                    <header class="ezone__header">
                        <div class="ezone__headline">
                            <ul class="ezone__breadcrumbs list-nostyle">
                                <li>@lang('distributorarea::front_lang.travels.available_contests')</li>
                                <li>@lang('distributorarea::front_lang.travels.contests')</li>
                            </ul>
                            <h1 class="ezone__title">TÍTULO DEL VIAJE</h1>
                            <h4 class="ezone__subtitle">@lang('distributorarea::front_lang.travels.validity_to') DD / MM / AA</h4>
                        </div>
                    </header>
                    ...
                    <div class="ezone__body">
                        ...
                        <div class="ezone__hscroll ps-container">
                            <ul class="list-nostyle">
                                <li>
                                    <figure><img src="{{ asset('themes/omnilife2018/images/slide-fronts-nfuerza.jpg') }}" alt=""></figure>
                                </li>
                                <li>
                                    <figure><img src="{{ asset('themes/omnilife2018/images/slide-fronts-nfuerza.jpg') }}" alt=""></figure>
                                </li>
