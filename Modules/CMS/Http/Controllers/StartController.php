...
class StartController extends Controller {
    ...
    public function index() {
        ...
        $active_zip = false;
        if (session()->get('portal.main.country_id') != null) {
            $exist_country = true;
        } else {
            $exist_country = false;
        }
        ...
        if ($exist_country == true) {
            $lan = $this->getCountryLanguages(session()->get('portal.main.country_id'));
            $languages = $lan['data'];
        } else {
        ...
        return View::make('cms::frontend.country', ['brand' => $brand_1,
                    ...
                    'country_id' => $exist_country ? session()->get('portal.main.country_id') : 0
        ]);
    }
