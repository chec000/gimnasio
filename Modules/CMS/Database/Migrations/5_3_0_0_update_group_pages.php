...
class UpdateGroupPages extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('cms_page_group_pages')->insert($addRows);*/
        ...
        Schema::table('cms_page_group', function (Blueprint $table) {
          $table->integer('url_priority')->default(50)->after('id');
        });
        ...
        $groupsController = DB::table('glob_admin_controllers')->select('id')->where('controller', '=', 'groups')->first();
